...
const float lifterMaxAngle = 145; // Software enforced angle limit [deg]
...
const float boomBinBPosition = 225; // The anglular position of bin B
const float boomBinCPosition = 135; // The anglular position of bin C
